...
var myFullpage = new fullpage('#fullpage', {
    ...
    anchors: ['home','comunity','shortstays','hospitality','culture','investment','maps']
});
$(document).on('click', '#home_s', function(){
    fullpage_api.moveTo('home', 1);
});
$(document).on('click', '#comunity_s', function(){
    fullpage_api.moveTo('comunity', 1);
});

$(document).on('click', '#shortstays_s', function(){
    fullpage_api.moveTo('shortstays', 1);
});

$(document).on('click', '#hospitality_s', function(){
    fullpage_api.moveTo('hospitality', 1);
});

$(document).on('click', '#culture_s', function(){
    fullpage_api.moveTo('culture', 1);
});

$(document).on('click', '#investment_s', function(){
    fullpage_api.moveTo('investment', 1);
});

$(document).on('click', '#maps_s', function(){
